...
namespace Tasks
{
    ...
    public class GoldAccount : Account
    {
        ...
        public GoldAccount(int id, string name, string surname, decimal amount, int bonus) : base(id, name, surname, amount, bonus)
        {
        }
        ...
        public GoldAccount(int id, string name, string surname, decimal amount, int bonus, IBonus bonusToWithdraw, IBonus bonusToReplenishment)
        ...
        /// </summary>
        public override int BonusPointToWithdraw { get; set; } = 5;

        /// <summary>
        /// Default bonus value for replenishment
        /// </summary>
        public override int BonusPointToReplenishment { get; set; } = 5;

        /// <summary>
        /// Set type pf account
        /// </summary>
        public override AccountType AccountType { get; } = AccountType.Gold;
    }
}
